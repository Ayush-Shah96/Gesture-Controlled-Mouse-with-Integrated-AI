...
class GestureController:
    ...
    def classify_hands(results):
        """
        Sets 'hr_major' and 'hr_minor' based on classification (left, right) of 
    ...
    def start(self):
        """
        Entry point of the whole program, captures video frame and passes,
        obtains landmark from mediapipe and passes it to 'handmajor' and 'handminor' for
        controlling.
        """
